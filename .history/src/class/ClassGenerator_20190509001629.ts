...
namespace ClassInformation {
	...
	export function processDescription(
		...
		return processText(data.description || "", rbxClasses) + processCodeSamples(data.code_sample || []);
	}
}
