...
(async () => {
	...
	const link = "https://developer.roblox.com/api-reference/function/Humanoid/EquipTool.json";
	new Promise((resolve, reject) => {
		...
		fetch(link)
			...
			.then(rawData => {
				...
				const cache = new Generator(classFolder, "BindToRenderStep" + ".ts");
				...
				cache.write("**" + processText(text) + samples + "*/");
