...
type HasClassName<T> = { [K in keyof T]: K extends "ClassName" ? K : never };

type Attk = HasClassName<RbxImageButton>[keyof RbxImageButton];
type Soup = ImageButton extends BaseTypes[keyof BaseTypes] ? true : false;
type Test3 = "ClassName" extends keyof ImageButton ? true : false;
