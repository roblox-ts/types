...
interface BrickColorConstructor {
	...
	White: () => ByPalletNumber[87];
	Gray: () => ByPalletNumber[123];
	DarkGray: () => ByPalletNumber[122];
	Black: () => ByPalletNumber[3];
	Red: () => ByPalletNumber[68];
	Yellow: () => ByPalletNumber[71];
	Green: () => ByPalletNumber[8];
	Blue: () => ByPalletNumber[21];
