...
interface BrickColor<
	Number extends RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["Number"] = RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["Number"],
	Name extends RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["Name"] = RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["Name"],
	r extends RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["r"] = RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["r"],
	g extends RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["g"] = RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["g"],
	b extends RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["b"] = RbxInternalBrickColorsByNumber[keyof RbxInternalBrickColorsByNumber]["b"],
> {
