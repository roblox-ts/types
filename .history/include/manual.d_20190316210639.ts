...
type FriendOnlineInGameInfo = FriendLocationTemplate<
	FriendLocationType.MobileInGame | FriendLocationType.InGame | FriendLocationType.TeamCreate
> &
	FriendOnlineInfoFields &
	FriendOnlineInGameInfo;

type FriendOnlineStudioInfo = FriendLocationTemplate<FriendLocationType.Studio> &
	FriendOnlineInfoFields &
	Pick<FriendsOnlineInGameInfo, "PlaceId">;

type FriendOnlineInfo = FriendOnlineWebsiteInfo | FriendOnlineInGameInfo | FriendOnlineStudioInfo;
