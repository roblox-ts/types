...
interface ArrayConstructor {
	 ...
	 * If length is provided, will load `length` amount of nil's into the new array.
	 * Note that this does not affect the `length` property of the array, it only keeps it from needing to resize.
	 */
