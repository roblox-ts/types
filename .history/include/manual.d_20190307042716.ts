...
interface RbxTweenService {
	Create<T extends Instances & keyof T extends "ClassName">(instance: T, tweenInfo: TweenInfo, propertyTable: Partial<FilterMembers<BaseTypes[T["ClassName"]], Tweenable>>): Tween;
}
