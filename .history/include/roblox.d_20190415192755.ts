...
/** A dictionary of an id and name containing information about what type an asset is. [Source](https://developer.roblox.com/articles/Asset-types) */
type AssetTypeData =
;
...
interface CharacterAppearanceInfo {
	...
	assets: Array<{
		...
		assetType:  { id: AssetType.Image; name: "Image" }
	| { id: AssetType.TeeShirt; name: "TeeShirt" }
	| { id: AssetType.Audio; name: "Audio" }
	| { id: AssetType.Mesh; name: "Mesh" }
	| { id: AssetType.Lua; name: "Lua" }
	| { id: AssetType.Hat; name: "Hat" }
	| { id: AssetType.Place; name: "Place" }
	| { id: AssetType.Model; name: "Model" }
	| { id: AssetType.Shirt; name: "Shirt" }
	| { id: AssetType.Pants; name: "Pants" }
	| { id: AssetType.Decal; name: "Decal" }
	| { id: AssetType.Head; name: "Head" }
	| { id: AssetType.Face; name: "Face" }
	| { id: AssetType.Gear; name: "Gear" }
	| { id: AssetType.Badge; name: "Badge" }
	| { id: AssetType.Animation; name: "Animation" }
	| { id: AssetType.Torso; name: "Torso" }
	| { id: AssetType.RightArm; name: "RightArm" }
	| { id: AssetType.LeftArm; name: "LeftArm" }
	| { id: AssetType.LeftLeg; name: "LeftLeg" }
	| { id: AssetType.RightLeg; name: "RightLeg" }
	| { id: AssetType.Package; name: "Package" }
	| { id: AssetType.GamePass; name: "GamePass" }
	| { id: AssetType.Plugin; name: "Plugin" }
	| { id: AssetType.MeshPart; name: "MeshPart" }
	| { id: AssetType.HairAccessory; name: "HairAccessory" }
	| { id: AssetType.FaceAccessory; name: "FaceAccessory" }
	| { id: AssetType.NeckAccessory; name: "NeckAccessory" }
	| { id: AssetType.ShoulderAccessory; name: "ShoulderAccessory" }
	| { id: AssetType.FrontAccessory; name: "FrontAccessory" }
	| { id: AssetType.BackAccessory; name: "BackAccessory" }
	| { id: AssetType.WaistAccessory; name: "WaistAccessory" }
	| { id: AssetType.ClimbAnimation; name: "ClimbAnimation" }
	| { id: AssetType.DeathAnimation; name: "DeathAnimation" }
	| { id: AssetType.FallAnimation; name: "FallAnimation" }
	| { id: AssetType.IdleAnimation; name: "IdleAnimation" }
	| { id: AssetType.JumpAnimation; name: "JumpAnimation" }
	| { id: AssetType.RunAnimation; name: "RunAnimation" }
	| { id: AssetType.SwimAnimation; name: "SwimAnimation" }
	| { id: AssetType.WalkAnimation; name: "WalkAnimation" }
	| { id: AssetType.PoseAnimation; name: "PoseAnimation" }
	| { id: AssetType.EarAccessory; name: "EarAccessory" }
	| { id: AssetType.EyeAccessory; name: "EyeAccessory" };
