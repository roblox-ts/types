...
interface FriendOnlineInfoFields {
	...
	GameId: string;
	/** The location type of the friends last location. 0 for mobile website. 1 for mobile in game. 2 for website. 3 for studio. 4 for in-game. */
...
/** When LocationType is Studio, for example, everything but GameId is present */
type FieldsPresentWhen<T, M extends keyof T, E extends T[M]> = { [P in keyof T]: P extends K ? T[P] : undefined };

type MyType = FieldsPresentWhen<
	FriendOnlineInfoFields,
	"LocationType",
