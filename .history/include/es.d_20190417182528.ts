...
declare class PrivateIterator<T> {
	private next(value?: any): IteratorResult<T>;
	private return?(value?: any): IteratorResult<T>;
	private throw?(e?: any): IteratorResult<T>;
}

declare class SafeIterable<T> {
	private [Symbol.iterator](): PrivateIterator<T>;
}
