...
interface RbxAnimationController extends RbxDerivesFromInstance {
	readonly AnimationPlayed: RBXScriptSignal<(animationTrack: AnimationTrack) => void>;
	GetPlayingAnimationTracks(): Array<AnimationTrack>;
	LoadAnimation(animation: Animation): AnimationTrack;
}

interface RbxAnimator extends RbxDerivesFromInstance {
	LoadAnimation(animation: Animation): AnimationTrack;
}

interface RbxAssetService extends RbxDerivesFromInstance {
...
interface RbxBasePart extends RbxDerivesFromInstance {
...
interface RbxBindableEvent extends RbxDerivesFromInstance {
...
interface RbxBindableFunction extends RbxDerivesFromInstance {
...
interface RbxCamera extends RbxDerivesFromInstance {
...
interface RbxChat extends RbxDerivesFromInstance {
...
interface RbxClickDetector extends RbxDerivesFromInstance {
...
interface RbxCollectionService extends RbxDerivesFromInstance {
...
interface RbxContentProvider extends RbxDerivesFromInstance {
	PreloadAsync(contentIdList: Array<Instance>): void;
}

/** @rbxts client */
interface RbxContextActionService extends RbxDerivesFromInstance {
...
/** @rbxts server */
interface RbxDataStoreService extends RbxDerivesFromInstance {
...
interface RbxDialog extends RbxDerivesFromInstance {
...
interface RbxGamePassService extends RbxDerivesFromInstance {
	PlayerHasPass(player: Player, gamePassId: number): boolean;
}

/** @rbxts server */
interface RbxGlobalDataStore extends RbxDerivesFromInstance {
...
interface RbxGroupService extends RbxDerivesFromInstance {
...
interface RbxGuiService extends RbxDerivesFromInstance {
...
interface RbxHapticService extends RbxDerivesFromInstance {
...
/** @rbxts server */
interface RbxHttpService extends RbxDerivesFromInstance {
...
interface RbxHumanoid extends RbxDerivesFromInstance {
	readonly AnimationPlayed: RBXScriptSignal<(animationTrack: AnimationTrack) => void>;
...
interface RbxInsertService extends RbxDerivesFromInstance {
...
interface RbxDerivesFromInstance {
...
interface RbxJointInstance extends RbxDerivesFromInstance {
	Part0: BasePart | undefined;
	Part1: BasePart | undefined;
}

interface RbxKeyframe extends RbxDerivesFromInstance {
	AddPose(pose: Pose): void;
	GetPoses(): Array<Pose>;
	RemovePose(pose: Pose): void;
}

interface RbxKeyframeSequence extends RbxDerivesFromInstance {
	AddKeyframe(keyframe: Keyframe): void;
	GetKeyframes(): Array<Keyframe>;
	RemoveKeyframe(keyframe: Keyframe): void;
}

interface RbxKeyframeSequenceProvider extends RbxDerivesFromInstance {
...
interface RbxLocalizationService extends RbxDerivesFromInstance {
...
interface RbxLocalizationTable extends RbxDerivesFromInstance {
...
interface RbxLogService extends RbxDerivesFromInstance {
...
interface RbxMarketplaceService extends RbxDerivesFromInstance {
	/**
...
interface RbxPath extends RbxDerivesFromInstance {
...
interface RbxPathfindingService extends RbxDerivesFromInstance {
...
interface RbxPhysicsService extends RbxDerivesFromInstance {
...
interface RbxPlayer extends RbxDerivesFromInstance {
...
interface RbxPlayers extends RbxDerivesFromInstance {
	/** @rbxts client */
	LocalPlayer: Player;
...
interface RbxPointsService extends RbxDerivesFromInstance {
...
interface RbxRemoteEvent extends RbxDerivesFromInstance {
...
interface RbxRemoteFunction extends RbxDerivesFromInstance {
...
interface RbxSocialService extends RbxDerivesFromInstance {
...
interface RbxSoundService extends RbxDerivesFromInstance {
	GetListener():
...
interface RbxTeam extends RbxDerivesFromInstance {
	readonly PlayerAdded: RBXScriptSignal<(player: Player) => void>;
	readonly PlayerRemoved: RBXScriptSignal<(player: Player) => void>;
	GetPlayers(): Array<Player>;
}

interface RbxTeams extends RbxDerivesFromInstance {
	GetTeams(): Array<Team>;
}
