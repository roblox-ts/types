...
interface BasePart extends RbxInstance {
...
/** @rbxts server */
interface GlobalDataStore extends RbxInstance {
...
interface GuiObject extends RbxGuiBase2d {
...
interface JointInstance extends RbxInstance {
...
interface ServiceProvider extends RbxInstance {
