...
interface ContextActionService extends RbxInternalInstance {
	...
	BindActivate(
		userInputTypeForActivation: CastsToEnum<Enum.UserInputType>,
		keyCodeForActivation?: CastsToEnum<Enum.KeyCode>,
	): void;
...
interface Humanoid extends RbxInternalInstance {
	...
	readonly StateChanged: RBXScriptSignal<
		(oldValue: Enum.HumanoidStateType, newValue: Enum.HumanoidStateType) => void
	>;
...
interface Player extends RbxInternalInstance {
	...
	readonly OnTeleport: RBXScriptSignal<
		(teleportState: Enum.TeleportState, placeId: number, spawnName: string) => void
	>;
...
interface PointsService extends RbxInternalInstance {
	...
	readonly PointsAwarded: RBXScriptSignal<
		(userId: number, pointsAwarded: number, userBalanceInGame: number, userTotalBalance: number) => void
	>;
}
...
Tags: ReadOnly, NotReplicated */
	...
	readonly ServerCollectConditionalResult: RBXScriptSignal<
		(condition: boolean, text: string, script: Instance, line: number) => void
	>;
	/** [LACKS DOCUMENTATION] */
...
interface UserInputService extends RbxInternalInstance {
	...
	readonly TouchSwipe: RBXScriptSignal<
		(swipeDirection: Enum.SwipeDirection, numberOfTouches: number, gameProcessedEvent: boolean) => void
	>;
	/** Fired when a user taps their finger on a TouchEnabled device. 'touchPositions' is a Lua array of Vector2, each indicating the position of all the fingers involved in the tap gesture. This event only fires locally.  This event will always fire regardless of game state. */
	...
	IsGamepadButtonDown(
		...
		gamepadKeyCode: CastsToEnum<Enum.KeyCode>,
	): boolean;
