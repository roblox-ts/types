...
interface TeleportService extends RbxInternalInstance {
	...
	GetArrivingTeleportGui(): ScreenGui | undefined;
	/** @rbxts client */
	...
	Teleport(placeId: number, player?: Player, teleportData?: RbxInternalTeleportData, customLoadingScreen?: ScreenGui): void;
}
