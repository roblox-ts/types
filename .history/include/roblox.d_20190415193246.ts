...
interface AssetProductInfo extends ProductInfo {
	...
	AssetId: number;
	/** The [type of asset](https://developer.roblox.com/articles/Asset-types) (e.g. place, model, shirt). In TypeScript, you should compare this to a member of the AssetTypeId const enum. */
