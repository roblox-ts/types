...
## Windows
```
npm i rbx-types & npm i rbx-safe-types & cd node_modules & MOVE /Y rbx-safe-types\include\* rbx-types\include & DEL rbx-types\include\manual.d.ts
```
...
Due to TypeScript's caching, you might see some definition conflicts for about 30 seconds. Feel free to restart VSCode by pressing (Ctrl+Shift+P) and selecting Reload Window.
