...
## Windows
```
npm i rbx-types & npm i rbx-safe-types & CD node_modules & MOVE /Y rbx-safe-types\include rbx-types & DEL rbx-types\include\manual.d.ts & DEL rbx-safe-types\include & CD ..
```
