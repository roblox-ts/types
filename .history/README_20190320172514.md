...
- rbx-safe-types removes 99% of the internal `Rbx_` classes. There are a few remaining, which now carry the prefix `RbxInternal` instead to be in PascalCase and to avoid confusion for users.
