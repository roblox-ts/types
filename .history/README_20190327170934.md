...
## Windows
```
npm i rbx-types & npm i rbx-safe-types & CD node_modules & MOVE /Y rbx-safe-types\include\* rbx-types\include & DEL rbx-types\include\manual.d.ts & RMDIR rbx-safe-types\include & CD ..
```

```
npm i rbx-types & npm i rbx-safe-types & CD node_modules\rbx-safe-types & MOVE /Y include\* rbx-types\include & DEL rbx-types\include\manual.d.ts & RMDIR include & CD ..
```
