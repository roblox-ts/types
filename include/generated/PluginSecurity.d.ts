...
interface RunService extends Instance {
	 ...
	 *
	 * IsEdit will return the inverse of [RunService.IsRunning](https://developer.roblox.com/api-reference/function/RunService/IsRunning) with one exception, if the simulation has been ‘paused’ then both IsEdit and [RunService.IsRunning](https://developer.roblox.com/api-reference/function/RunService/IsRunning) will return false.
	 *
